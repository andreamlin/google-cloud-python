...
`Google Cloud Pub/Sub API`_: Provides reliable, many-to-many, asynchronous messaging between
applications.
...
.. _Client Library Documentation: https://googlecloudplatform.github.io/google-cloud-python/stable/pubsub/usage.html
